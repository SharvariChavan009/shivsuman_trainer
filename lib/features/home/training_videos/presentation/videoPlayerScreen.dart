...
class _VideoPlayerScreen1State extends State<VideoPlayerScreen1> {
  ...
  @override
  void dispose() {
    videoPlayerController.removeListener(_updateFormattedTime);
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                            isScrubeed ? _updateFormattedTime() :  "-",
                                              style: TextStyle(
                                                  color: Colors.white),
                                            ),
                                          ],
